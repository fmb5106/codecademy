...
function getElementY(query) {
  ...
  document.querySelector('.fa-angle-double-down').addEventListener('click', doScrolling.bind(null, '#middle', 1000))
  document.getElementById('scrollBottom').addEventListener('click', doScrolling.bind(null, '#bottom', 1500))
